...
func (er erasureObjects) GetObjectDebugInfo(ctx context.Context, bucket, object string, opts ObjectOptions, prefix string) (debugInfo map[string]string) {
	lk := er.NewNSLock(bucket, object)
	if err := lk.GetRLock(ctx, globalOperationTimeout); err != nil {
		return nil
	}
...
func (er erasureObjects) GetObjectInfo(ctx context.Context, bucket, object string, opts ObjectOptions) (info ObjectInfo, err error) {
	_ = er.GetObjectDebugInfo(ctx, bucket, object, opts, "1")
	// Lock the object before reading.
	lk := er.NewNSLock(bucket, object)
	if err := lk.GetRLock(ctx, globalOperationTimeout); err != nil {
